...
int main()
{
    ...
    //kam karanq parzapes mekum dnenq anuny get_size_obj isk myusum get_size_obj2,bayc kara nenc depq lini vor esel chprli,da hetevyal depqn e`ka mihat General class vorum ktexadrenq et get_size_obj funkcian ev GeomBase-@@ ev GeomSerialize-@ kjarangenq et General-ic
}
