...
Cat& Cat::operator=(const Cat& other)
{
   ...
   Animal::operator=(other);//Animal op=-@ veradarcnuma Animal& baayc es toxum chen gre *this = Animal::operator=(other);,es chem gre et *this =-i pahy bayc qani vor member functioni meja katarvel et Animali op=,et popoxutyuny kazdi this-i vra
